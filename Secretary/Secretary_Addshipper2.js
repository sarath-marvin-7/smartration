                          ...
                          <div class="add-ship__content-right">
                             <p class="add-ship__para">&nbsp;</p>
                              ...
                              <div class="add-ship__row">
                               ...
                               <div class="add-ship__row">
                                  <div class="add-ship__col1">
                                        <label class="label">Qualification</label></div>
                                    <div class="add-ship__col2"><input type="text" name="qualification" class="inputtxt" required>
                                    </div>
                                </div>

                                <div class="add-ship__row"><div class="add-ship__col1"></div><div class="add-ship__col2"> Speicfy the qualification<br> Eg: 10th, 12th, Diploma / ITI, Degree   </div></div>
