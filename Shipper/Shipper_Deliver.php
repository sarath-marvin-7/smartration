...
<head>
    ...
    <link rel="stylesheet" href="Shipper_Deliver_style.css">
...
if($res->num_rows>0){
    ...
    while($row=$res->fetch_assoc()){
        ...
        /*echo "<td><form action=#popup-delivered method=post id=delivered-form>
        <input type=submit value=DELIVERED name=deliver-btn class=delivered-btn></form></td>";*/
        ...
        echo "<td><a href=Not_delivered_Packages.php?id={$row["SmartCardID"]} class=not-delivered-link>NOT-DELIVERED</a></td>";
        echo "</tr>";
    }
    echo "</table></center>";
} else{
    echo "<center><h3 style=margin-top:30px;>No Packages for Shipping</h3></center>";
}
                   
/*------METHOD 1-----------*/                   
/*                   
if(isset($_POST['deliver-btn'])){
