...
<head>
    ...
    <link rel="stylesheet" href="Secretary_Viewshipper_style.css">
...
<body>
    <div class="header">
             ...
             <div class="back">
            <a href="Secretary_Addshipper.php" class="back-link">BACK</a>
             </div>
    </div>
    <h2 style="text-align:center; margin-top:50px;">SHIPPER DETAILS</h2>
</body>
</html>
